...
# タイトルと説明
# ============================================
st.title("Streamlit 提出課題")

# ============================================
# サイドバー 
# ============================================
st.sidebar.header("課題")
st.sidebar.info("課題に取り組みました。")

# ============================================
# 基本的なUI要素
# ============================================
st.header("基本的な UI 要素")
...
if st.checkbox("チェックを入れるとコンテンツが表示されます"):
...
with col1:
    st.write("こちらは左カラムです。")
    st.number_input("数値を入力してください", value=10)
with col2:
    st.write("こちらは右カラムです。")
    st.metric("メトリクス例", "42", "+2%")
